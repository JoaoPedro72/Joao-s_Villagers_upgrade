...
execute as @n[tag=j.criar_bancada_guarda] at @s align xyz run summon minecraft:item_display ~.5 ~.5 ~.5 {CustomName:[{text:Bancada_Guarda}],Tags:["j.bloco","j.bloco.guarda"],item:{id:"minecraft:crafting_table",Count:1b}}
