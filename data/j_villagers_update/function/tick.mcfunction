...
execute as @e[type=villager] at @s if data entity @s VillagerData{profession:"minecraft:librarian"} run function j_villagers_update:bibliotecario/tick
execute as @e[type=villager] at @s if data entity @s VillagerData{profession:"minecraft:butcher"} run function j_villagers_update:acougueiro/tick
...
function j_villagers_update:bancadas/invocar_bancada
